...
import { deleteReport, updateReport, listReportByPage } from '@/services/reportService'
    ...
    <PageContainer>
      <ProTable<ReportType.Report>
        ...
        request={async (params, sorter) => {
          const searchParams: ReportType.ReportQueryRequest = { ...params }
